...
class Fn(Expression):
    """
    This class represents anonymous functions (lambda expressions). 
    A function expression "fn x => e" represents a function that takes
    parameter x and evaluates expression e in an extended environment.
    """
    ...
    def accept(self, visitor, arg):
        ...
        >>> # This represents the function fn x => x + 1
        """
        return visitor.visit_fn(self, arg)

class App(Expression):
    """
    This class represents function application. An application expression
    applies a function to an argument. The expression "f arg" applies
    function f to argument arg.
    """
    ...
    def accept(self, visitor, arg):
        ...
        >>> f = Fn('x', Add(Var('x'), Num(1)))
        >>> app = App(f, Num(5))
        >>> # This represents applying the function (fn x => x + 1) to 5
