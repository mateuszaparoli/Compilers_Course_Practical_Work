...
class Lexer:
    ...
    def getToken(self):
        ...
        if current_char.isdigit():
            ...
            elif identifier_text == "not":
                return Token(identifier_text, TokenType.NOT)
            elif identifier_text == "val":
                return Token(identifier_text, TokenType.VAL)
            elif identifier_text == "fun":
                return Token(identifier_text, TokenType.FUN)
            elif identifier_text == "fn":
                return Token(identifier_text, TokenType.FNX)
            elif identifier_text == "div":
                return Token(identifier_text, TokenType.DIV)
            elif identifier_text == "mod":
                return Token(identifier_text, TokenType.MOD)
            elif identifier_text == "int":
                return Token(identifier_text, TokenType.INT)
            elif identifier_text == "bool":
                return Token(identifier_text, TokenType.LGC)
            else:
